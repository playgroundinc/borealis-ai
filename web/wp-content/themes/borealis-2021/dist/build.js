...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return QueryParams; });
class QueryParams {
  constructor(param) {
    this.param = param;
    this.UrlParams = new URLSearchParams(window.location.search);
...
function search() {
  ...
  const checkboxSearchForm = container => {
    ...
    const checkboxEls = document.querySelectorAll("input[type='checkbox']"); // Params and current values
    ...
    let topicsNum = parseInt(topics.innerHTML); // Taxonomy button

    const taxonomyButton = document.getElementById(container.id); // Adds taxonomy to query params if not already present
    ...
    function clearAllCheckboxes() {
      ...
      window.location.href = window.location.origin + window.location.pathname; // Set selections to empty object
...
// heroVideo();
>>>>>>> 0cd208ebb2984322d457abae210c8400c8839d1f
