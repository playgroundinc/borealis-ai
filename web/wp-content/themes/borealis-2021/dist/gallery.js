/******/ (function () {
			...
			/***/ function (
				...
				class GalleryClass {
					...
					setHeight() {
						...
						if (listItems.length > 0) {
							const heights = listItems.map((item) => {
								...
								return Number(item.offsetHeight) + 120;
							});
					...
					handleMouseMove(e) {
						...
						this.selector.scrollLeft =
							Number(this.selector.scrollLeft) - Number(drag);
  ...
  \***********************************/
		__webpack_require__.r(__webpack_exports__);
		/* harmony import */ var _classes_class_gallery__WEBPACK_IMPORTED_MODULE_0__ =
			__webpack_require__(
				/*! ./classes/class-gallery */ "./src/js/scripts/classes/class-gallery.js"
			);
		...
		function galleries() {
			...
			if (galleries.length > 0) {
				galleries.forEach((gallery) => {
					const Gallery =
						new _classes_class_gallery__WEBPACK_IMPORTED_MODULE_0__["default"](
							gallery
						);
					Gallery.init();
				});
