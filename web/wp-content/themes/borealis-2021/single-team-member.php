...
$paragraphs = array_filter($blocks, function($block) { return $block['blockName'] === 'pg/paragraph'; });
$allowed_html = pg_allowed_html();
$additional_content = array_filter($blocks, function($block) { return $block['blockName'] !== 'pg/paragraph' && $block['blockName'] !== 'pg/team-member-meta'; });
?>
<main id="main-content" class="main-content container pt-25">
    <div class="md:flex justify-between">
        ...
        <?php endif; ?>
        <div class="<?php echo isset($image) && strlen($image) > 0 ? esc_attr('basis-8/12 pt-14 md:pt-0') : esc_attr('w-full'); ?> shrink-0 paragraph-style">
