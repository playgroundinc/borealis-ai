...
export default function trmcBodyCopyImageBlock() {
	const { registerBlockType } = wp.blocks;
	const { i18n } = wp;

	const blockSlug = "body-copy-image";
	const blockTitle = "News - Image";
		...
		edit: (props, editor = false, save = false) => {
			...
			return [
                <div className="custom-child">
                    <p className="block-title">News - Image</p>
                    <p style={{ fontSize: '14px', fontStyle: 'italic'}}>Images should be at least 745px wide and 620px tall. Larger images will be cropped with a central focal point.</p>
                    <CustomImageUpload
                        components={[
                            {
                                value: image_url,
