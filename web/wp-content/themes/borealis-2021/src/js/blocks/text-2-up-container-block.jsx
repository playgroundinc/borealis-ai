...
export default function text2UpContainerBlock() {
	...
	registerBlockType(`${namespace}/${blockSlug}`, {
		...
		edit: (props, editor = false, save = false) => {
			...
			const bgStyles = [
				{
					label: "Default",
					value:
						"bg-shade-white-400 text-shade-black-400 before:bg-shade-black-400",
				},
				{
					label: "Grey",
					value:
						"bg-shade-grey-100 text-shade-black-400 before:bg-shade-black-400",
				},
				{
					label: "Purple",
					value:
						"bg-primary-purple-400 text-shade-white-400 before:bg-shade-white-400",
				},
				{
					label: "Navy",
					value:
						"bg-primary-navy-400 text-shade-white-400 before:bg-shade-white-400",
				},
				{
					label: "Light Blue",
					value:
						"bg-tint-lightBlue-400 text-shade-white-400 before:bg-shade-white-400",
				},
				{
					label: "Light Purple",
					value:
						"bg-tint-purple-400 text-shade-white-400 before:bg-shade-white-400",
				},
			];
			...
			const copyStyles = [
				{ label: "Large", value: "paragraph-lg tb:paragraph-lg-desktop" },
