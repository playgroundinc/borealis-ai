...
export default function pageStripBlock() {
  ...
  const stringAttributes = ["bg_color", "title"];
  ...
  registerBlockType(`${namespace}/${slug}`, {
      ...
      to: [
        {
          ...
          transform: (attributes, innerBlocks) => {
            return wp.blocks.createBlock(`${namespace}/page-strip-graphic`, attributes, innerBlocks);
          },
        },
      ],
    },
    edit: (props, editor = false, save = false) => {
      ...
      const { bg_color, title } = attributes;
          ...
          <section>
            <div>
              <div>
                ...
                />
                {save ? <InnerBlocks.Content /> : <InnerBlocks allowedBlocks={[`${namespace}/paragraph-no-alignment`, "core/buttons"]} />}
              </div>
            </div>
          </section>
        </div>,
