...
if (!function_exists('pg_register_research_area_taxonomy')) {
    ...
    function pg_register_research_area_taxonomy() {
        ...
        $Research_Area_Taxonomy = new PG_Custom_Taxonomy('research-areas', 'Research Area', 'Research Areas', array('post_types' => array('research-blogs', 'publications', 'news', 'team-member')));
