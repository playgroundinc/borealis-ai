...
if (!function_exists('pg_register_research_blog_cpt')) {
    ...
    function pg_register_research_blog_cpt() {
        ...
        $Research_Blogs_CPT = new PG_Custom_Post_Type('research-blogs', 'Research Blog', 'Research Blogs', array('icon' => 'dashicons-category', 'has_archive' => 'false', 'template' => [ [$namespace . '/research-blogs-meta-block'], [ $namespace . '/custom-section-block']]));
