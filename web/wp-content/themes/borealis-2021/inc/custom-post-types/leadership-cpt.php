...
if (!function_exists('pg_register_leadership_cpt')) {
    ...
    function pg_register_leadership_cpt() {
        ...
        $Leadership_CPT = new PG_Custom_Post_Type('leadership', 'Leadership', 'Leadership', array('icon' => 'dashicons-admin-users', 'has_archive' => 'false', 'template' => [ [$namespace . '/leadership-meta-block']]));
