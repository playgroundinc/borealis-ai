...
?>
        ...
        <p class="pt-xs-1">You can find the full technical documentation <a href="https://docs.google.com/document/d/1zjz-5XHUsj5sWiowjYHHoyJfaTGPRQmsTXngMmi6jLw/edit#">here</a></p>
        <div class="mt-xs-4">
            <h2 class="mb-xs-0">3rd Party Integrations</h2>
            <p class="mt-xs-1">This is where you would add your Google Tag Manager container ID and your Greenhouse API key.</p>
        ...
        <div class="mt-xs-4">
            ...
            <p class="mt-xs-1">This is where you would add the copy for the 404 page.</p>
        ...
        <div class="mt-xs-4">
            ...
            <p class="mt-xs-1">This is where you would add the copy for the cookies notification.</p>
        ...
        <div class="mt-xs-4">
            ...
            <p class="mt-xs-1">This is where you would add the copy for the footer.</p>
        ...
        <div class="mt-xs-4">
            ...
            <p class="mt-xs-1">This is where you would add the links for the social media accounts in the footer.</p>
