        ...
        <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" style="display: none">
            ...
            <symbol id="icon-hamburger" viewBox="0 0 24 24">
                <g transform="translate(1 5.5)" fill="currentColor" fill-rule="nonzero">
                    <rect width="22" height="2.364" rx="1" />
                    <rect y="5.318" width="22" height="2.364" rx="1" />
                    <rect y="10.636" width="22" height="2.364" rx="1" />
                </g>
            </symbol>
            ...
            <!-- Careers Speech Icon -->
            <symbol id="icon-careers" viewBox="0 0 73 24" fill="none" aria-hidden="true">
            ...
            <symbol id="icon-plus" viewBox="0 0 22 22">
                <g stroke="currentColor" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M11.0002 1.5719v18.8562M1.5721 11h18.8562" />
                </g>
            </symbol>
            ...
            <symbol id="icon-arrow-left" viewBox="0 0 18 18">
                <g stroke="currentColor" stroke-width="2" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M2 9h14M2 9l4 4M2 9l4-4" />
                </g>
            </symbol>
            ...
            <symbol id="icon-search-publication" viewBox="0 0 22 22">
                <g transform="translate(3 3)" stroke="currentColor" stroke-width="2" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round">
                    <ellipse cx="6.417" cy="6.354" rx="6.417" ry="6.354" />
                    <path d="M16.5 16.339 11 10.893" />
                </g>
            </symbol>
            ...
            <symbol id="icon-search" viewBox="0 0 14 14">
                <g transform="translate(2 2)" stroke="currentColor" stroke-width="2" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round">
                    <ellipse cx="4.083" cy="4.043" rx="4.083" ry="4.043" />
                    <path d="M10.5 10.397 7 6.932" />
                </g>
            </symbol>
            ...
            <symbol id="icon-menu-close" viewBox="0 0 14 14" fill="none">
                <g stroke-width="2" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="currentColor" d="M11.972 2 2.028 12" />
                    <path stroke="currentColor" d="m2 2 10 10" />
                </g>
            </symbol>
