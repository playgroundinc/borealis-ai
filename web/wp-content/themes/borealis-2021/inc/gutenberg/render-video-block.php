...
?>
        <div class="custom-component nestable animated-element">
            <div class="<?php echo !is_singular(array('news', 'research-blogs')) ? esc_attr('container') : '' ?> relative video-block rounded-large overflow-hidden pt-video md:pt-video-md lg:pt-video-lg tb:min-h-[350px] lg:min-h-[435px]">
                    ...
                    <div class="bg-cover bg-center absolute inset-0 z-10 video-block__overlay transition-all duration-400" style="background-image: url(<?php echo esc_url_raw($image) ?>)">
                        <a class="block w-full h-full video-block__overlay__button" href="#" aria-label="<?php echo esc_attr('Play video') ?>">
                            <div class="flex w-full h-full items-center justify-center">
                                <span class="text-shade-white-400 paragraph-lg lg:paragraph-lg-desktop md:h2-desktop">
                                    <?php
                ...
                <?php endif; ?>
                <div class="flex w-full h-full justify-start tb:justify-center items-center absolute inset-0">
