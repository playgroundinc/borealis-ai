                    ...
                    <section class="tab-container container" aria-labelledby="<?php echo esc_html(pg_slugify($attributes->title)) ?>">
                        <?php if ($dark && $attributes->display_style === 'background-image'): ?>
                            <div class="lg:flex justify-between">
                                ...
                                <div class="lg:basis-7/12 shrink-0 pt-14 lg:pt-0">
                                    <?php foreach ($block['innerBlocks'] as $inner_block => $element): ?>
                                        <?php
                                            ...
                                            <?php if ($inner_block === key($block['innerBlocks'])): ?>                                      
                                                <div class="block" id="<?php echo esc_attr($titleSlug .'-content-panel')?>" role="tabpanel" aria-labelledby="<?php echo esc_attr($titleSlug.'-tab') ?>">
                                                    <?php 
                                            ...
                                            <?php else: ?>
                                                <div class="hidden" id="<?php echo esc_attr($titleSlug .'-content-panel')?>" role="tabpanel" aria-labelledby="<?php echo esc_attr($titleSlug.'-tab') ?>">
                                                    <?php 
                                                        foreach($element['innerBlocks'] as $panel) {
                                                            echo wp_kses(render_block($panel), $allowed_html);
                                                        }
                                ...
                                <div class="basis-8/12 shrink-0 pt-5 md:pt-0">
                                    ...
                                    <?php foreach ($block['innerBlocks'] as $inner_block => $element): ?>
                                        <?php
                                            ...
                                            ?>
                                            <?php if ($inner_block === key($block['innerBlocks'])): ?>                                      
                                                <div class="block pt-12" id="<?php echo esc_attr($titleSlug .'-content-panel')?>" role="tabpanel" aria-labelledby="<?php echo esc_attr($titleSlug.'-tab') ?>">
                                                    <?php 
                                                        foreach($element['innerBlocks'] as $panel) {
                                                            echo wp_kses(render_block($panel), $allowed_html);
                                                        }
                                            ...
                                            <?php else: ?>
                                                <div class="hidden pt-12" id="<?php echo esc_attr($titleSlug .'-content-panel')?>" role="tabpanel" aria-labelledby="<?php echo esc_attr($titleSlug.'-tab') ?>">
                                                    <?php 
                                                        foreach($element['innerBlocks'] as $panel) {
                                                            echo wp_kses(render_block($panel), $allowed_html);
                                                        }
