...
if ( function_exists( 'register_block_type' ) ) {
    ...
    register_block_type(
        ...
        array(
            'render_callback' => 'trmc_render_page_strip_block',
        )
    );
}

if ( ! function_exists( 'trmc_render_page_strip_block' ) ) {
    /**
     ...
     */
    function trmc_render_page_strip_block( $attrs, $content, $block_obj ) {
