...
if ( function_exists( 'register_block_type' ) ) {
    ...
    register_block_type(
        ...
        array(
            'render_callback' => 'trmc_render_testimonial_slider_container_block',
            'script'          => 'carousel',
        )
    );
}

if ( ! function_exists( 'trmc_render_testimonial_slider_container_block' ) ) {
    /**
     ...
     */
    function trmc_render_testimonial_slider_container_block( $attrs, $content, $block_obj ) {
            ...
            ?>
                <div class="custom-component">
                    <div class="container container-fluid animated-element">
                        ...
                        >
                            <div class="slider-block testimonial-slider" aria-live="polite">
