...
?>
            <div class="custom-component animated-element testimonial-slider relative <?php echo $attributes->display_style === 'dark' ? esc_attr('component-dark') : ''; ?>">
                <?php if ($attributes->display_style === 'dark') : ?>
                    ...
                    <div id="<?php echo esc_attr($id); ?>" class="relative w-full pt-180 tb:pt-130 lg:pt-125 overflow-hidden border-r border-color-shade-grey-500" aria-roledescription="carousel" data-style="dark" <?php echo !empty($attributes->title) ? esc_html('aria-label="' . $attributes->title . '"') : null ?>>
        ...
        <?php else : ?>
            <div class="container md:flex">
                ...
                <div class="grow relative">
                    ...
                    <div id="<?php echo esc_attr($id); ?>" class="relative w-full pt-180 tb:pt-130 lg:pt-125 overflow-hidden" aria-roledescription="carousel" <?php echo !empty($attributes->title) ? esc_html('aria-label="' . $attributes->title . '"') : null ?>>
