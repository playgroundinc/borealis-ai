...
?>
        <li class="w-full sm:w-1/2 tb:w-1/4 border-l border-color-shade-grey-500 flex flex-col group shrink-0 slide" aria-roledescription="slide">
            <a class="border border-shade-transparent-400 focus:border-primary-electric-blue-400 focus:outline-0 block pt-5 pb-13 pl-6 md:pl-1.17vw pr-4 md:pr-2.9vw bg-shade-white-400 hover:bg-shade-grey-100 grow" href="<?php echo esc_url_raw($url); ?>">
