...
if (!function_exists('pg_render_job_highlight_block')) {
    function pg_render_job_highlight_block($attrs) {
        ...
        ob_start();
        ?>
        <div class="justify-between <?php echo !is_singular(array('news', 'research-blogs')) ? esc_attr('container') : '' ?> pt-7 <?php echo is_singular(array('news', 'research-blogs')) ? 'tb:flex' : 'hidden'?>">
