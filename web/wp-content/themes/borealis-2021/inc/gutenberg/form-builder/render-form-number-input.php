...
/**
 *
 * Render Form Number Input Block
 *
 * @package Trimac
 * @version 1.0.0
...
if ( function_exists( 'register_block_type' ) ) {
    ...
    register_block_type(
        ...
        array(
            'render_callback' => 'trmc_render_number_input_block'
        )
    );
}

if ( ! function_exists( 'trmc_render_number_input_block' ) ) {
    /**
     ...
     */
    function trmc_render_number_input_block( $attrs, $content, $block_obj ) {
        ...
        $name = str_replace(' ', '_', strtolower($attributes->label));
        ob_start();
        ?>
