...
if ( function_exists( 'register_block_type' ) ) {
    ...
    register_block_type(
        $namespace . '/textarea-input',
        array(
            'render_callback' => 'trmc_render_textarea_input_block'
        )
    );
}

if ( ! function_exists( 'trmc_render_textarea_input_block' ) ) {
    /**
     ...
     */
    function trmc_render_textarea_input_block( $attrs, $content, $block_obj ) {
