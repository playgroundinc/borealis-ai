...
<main id="content">
    ...
    <div class="load-more-results min-h-[400px] md:min-h-[800px]">
        ...
        <div class="<?php echo intval($Query->max_num_pages) > 1 ? '' : 'hidden' ?> border-solid border-b border-shade-grey-500 bg-shade-grey-50 hover:bg-primary-navy-400 hover:text-shade-white-400 transition-all duration-300 load-more">
