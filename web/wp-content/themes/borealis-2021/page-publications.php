...
<main id="content">
    ...
    ?>
        <div class="load-more-results min-h-[400px] md:min-h-[800px]">
            ...
            <div class="border-solid border-b border-color-shade-grey-500 hover:bg-primary-navy-400 hover:text-shade-white-400 transition-all duration-300 load-more">
